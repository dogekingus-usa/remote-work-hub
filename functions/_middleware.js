 ...
 * Site: RemoteWorkHub.net
 * Form: Remote Work Starter Kit (Kit UID: 75a59701df)
 */

const FORM_CONFIG = {
  heading: 'Get the Free Remote Work Starter Kit',
  desc: 'Office setup, timezone hacks, communication scripts.',
  btn: 'Send My Free Kit',
  bg: '#1e293b',
  accent: '#60a5fa',
  uid: '75a59701df'
};
